...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_bio = QtWidgets.QPushButton(parent=self.splitter_2)
        self.pushButton_bio.setStyleSheet("background-color: rgb(255, 193, 220)")
        self.pushButton_bio.setObjectName("pushButton_bio")
        self.pushButton_otchet = QtWidgets.QPushButton(parent=self.splitter_2)
        self.pushButton_otchet.setStyleSheet("background-color: rgb(255, 193, 220)")
        self.pushButton_otchet.setObjectName("pushButton_otchet")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_bio.setText(_translate("MainWindow", "Посмотреть биоматериал"))
        self.pushButton_otchet.setText(_translate("MainWindow", "Сформировать отчет"))
